#!/usr/bin/env python3
"""
Vivafolio Python Runtime Path Demo - Single Block
...
from vivafolio_helpers import vivafolio_picker, gui_state
...
if __name__ == "__main__":
    print("Vivafolio color picker above will show interactive editor!")
    print("Pick a color and see the gui_state comment update automatically.")
